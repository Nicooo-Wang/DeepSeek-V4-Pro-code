...
def rotate_activation(x: torch.Tensor) -> torch.Tensor:
    ...
    try:
        ...
        # Pure-torch fallback (see kernel.py) — used when fast_hadamard_transform is absent,
        # e.g. in the minimal debug venv. Numerically identical normalized Walsh-Hadamard.
        from kernel import hadamard_transform
